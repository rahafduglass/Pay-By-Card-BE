...
public class DomainBeansConfig {
    ...
    @Bean
    public CardDao cardDao(CardJpaRepository cardJpaRepository, CardEntityMapperImpl cardEntityMapper, PageDetailsMapper pageDetailsMapper) {
        return new CardDaoImpl(cardJpaRepository, pageDetailsMapper, cardEntityMapper);
    }

    @Bean
    public CardDaoImpl cardDaoImpl(CardJpaRepository cardJpaRepository, CardEntityMapperImpl cardEntityMapper, PageDetailsMapper pageDetailsMapper) {
        return new CardDaoImpl(cardJpaRepository, pageDetailsMapper, cardEntityMapper);
    }
}

...
//
//    @Test
//    public void givenValidPaymentModel_whenCallValidateCardThenProcess_shouldReturnSavedPaymentDto() {
...
//
//    @Test
//    public void givenInvalidAmount_whenCallValidatePaymentThenIniitiate_shouldThrowExceptionAtProcess() {
//        CardDto verifiedCard = mock(CardDto.class);
...
//        model = new InitiatePaymentModelImpl("items", BigDecimal.valueOf(23444), "client", cardTOVerify, paymentDao, cmsApiHandler);
//        model.validatePayment();
//        assertThrows(InsufficientCardBalance.class,()->model.process());
//    }
//
//    @Test
